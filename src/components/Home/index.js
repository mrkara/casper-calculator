...
export default class Home extends Component {
    ...
    getDaily(rateTmp){
        return parseFloat(rateTmp * 12).toFixed(5);
    }

    getMonthly(rateTmp){
        return parseFloat(rateTmp * 12 * 30).toFixed(5);
    }

    getApy(rateTmp){
        return parseFloat(rateTmp * 12 * 365 * 100).toFixed(5);
    }
    ...
    async getRewardRatio(delegator, staked_amount) {
        ...
        if (rewards) {
            ...
            //get average
            return total_ratio / reward_length;
        }
        return 0;
    }
    ...
    async tick() {
        ...
        if (validatorsInfo != null) {
            let valid_validators = 0;
            let total_staked = 0;
            let bids_length = validatorsInfo.auction_state.bids.length;
            for (let i = 0; i < bids_length; i++) {
                let delegator_length = validatorsInfo.auction_state.bids[i].bid.delegators.length;
                if (!validatorsInfo.auction_state.bids[i].bid.inactive) {
                    ...
                    for (let j = 0; j < delegator_length; j++) {
                        let staked_amount = parseFloat(validatorsInfo.auction_state.bids[i].bid.delegators[j].staked_amount / 1000000000);
    ...
    async changeStakedAmount(e) {
        this.setState({
            ...
            min_daily: this.getDaily(this.state.min_rate * e.target.value),
            max_daily:  this.getDaily(this.state.max_rate * e.target.value),
                        ...
                        <div className="row mb-3">
                            <div className="col-md-3">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.status ? utils.numberWithCommas(this.state.status.last_added_block_info.height) : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                            <div className="col-md-2">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.status ? utils.numberWithCommas(this.state.status.last_added_block_info.era_id) : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                            <div className="col-md-3">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">{this.state.price !== 0 ? this.state.price : "..."}
                                        <span className="section-sub-title">$</span></h3>
                                </form>
                            </div>
                            <div className="col-md-2">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.validatorsInfo ? this.state.valid_validators : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                            <div className="col-md-2">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.status ? this.state.status.peers.length : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                        </div>
                        <div className="row mb-5">
                            <div className="col-md-4">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.validatorsInfo ? utils.numberWithCommas(parseInt(this.state.total_staked)) : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                            <div className="col-md-4">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.status ? utils.numberWithCommas(this.state.circulating) : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                            <div className="col-md-4">
                                <form action="#" className="p-3 bg-white text-center">
                                    ...
                                    <h3 className="section-title">
                                        <strong>{this.state.status ? utils.numberWithCommas(this.state.totalSupply) : '...'}</strong>
                                    </h3>
                                </form>
                            </div>
                        </div>
                                ...
                                <form action="#" className="p-5 bg-white">
                                    <div className="row form-group">
                                        <div className="col-md-12 text-center">
                                            ...
                                            <p>Validator Node Name: <a href='https://blockshark.net'>BLOCKSHARK.NET</a>
                                            </p>
                                            <p>Commission: <a href='https://blockshark.net'>1%</a></p>
                                            <p>Address: <a
                                                href='https://cspr.live/validator/01791a70eece8f8e0e3d28d3f1b3abd5f86ce7732445501ed70c54759947d21153'
                                                target="_blank">{utils.truncateStr("01791a70eece8f8e0e3d28d3f1b3abd5f86ce7732445501ed70c54759947d21153", 9)}</a>
                                            </p>
                                            <a href='https://cspr.live/delegate-stake?validatorPublicKey=01791a70eece8f8e0e3d28d3f1b3abd5f86ce7732445501ed70c54759947d21153'
                                               className="btn btn-primary" target="_blank">STAKE NOW</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form action="#" className="p-5 bg-white">
                                    <div className="row form-group">
                                        <div className="col-md-12">
                                            ...
                                            <p>3. Rewards are distributed at the end of each era and automatically
                                                staked give CSPR stakers COMPOUNDING POWER</p>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form action="#" className="p-3 bg-white">
                                    <div className="row form-group">
                                        <div className="col-md-12">
                                            ...
                                            <input type="number" name="staked_amount"
                                                   value={this.state.user_staked_amount} className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                            <p style={{color: "red"}}>* Check <strong>Daily Reward</strong> column in
                                                the validator list for estimated earnings</p>
                                        </div>
                                    </div>
                                ...
                                <form action="#" className="p-3 bg-white">
                                    <div className="row form-group">
                                        <div className="col-md-12">
                                            ...
                                            <input type="text" name="search" placeholder="Blockshark"
                                ...
                                <form action="#" className="p-3 bg-white">
                                    <div className="row form-group">
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Min daily</strong></p>
                                            <input type="text" name="min_daily"
                                                   readOnly
                                                   value={this.state.min_daily + " CPSR"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Max daily</strong></p>
                                            <input type="text" name="max_daily"
                                                   readOnly
                                                   value={this.state.max_daily + " CPSR"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                    </div>
                                    <div className="row form-group">
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Min monthly</strong></p>
                                            <input type="text" name="min_monthly"
                                                   readOnly
                                                   value={this.state.min_monthly + " CPSR"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Max monthly</strong></p>
                                            <input type="text" name="max_monthly"
                                                   readOnly
                                                   value={this.state.max_monthly + " CPSR"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                    </div>
                                    <div className="row form-group">
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Min APY</strong></p>
                                            <input type="text" name="min_apy"
                                                   readOnly
                                                   value={this.state.min_apy + " %"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                        <div className="col-md-6">
                                            <p className="text-left"><strong>Max APY</strong></p>
                                            <input type="text" name="max_apy"
                                                   readOnly
                                                   value={this.state.max_apy + " %"}
                                                   className="form-control"
                                                   onChange={(e) => this.changeStakedAmount(e)}/>
                                        </div>
                                    </div>
                        ...
                        <div className="row mb-3">
                            <div className="col-12 text-center">
                                ...
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(3, this.state.sort_type3)}>Sort by Name</a>
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(4, this.state.sort_type4)}>Sort by Address</a>
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(2, this.state.sort_type2)}>Sort by Stakers</a>
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(0, this.state.sort_type0)}>Sort by Comm</a>
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(1, this.state.sort_type1)}>Sort by Reward</a>
                                <a href={void (0)} className="btn btn-primary"
                                   onClick={() => this.sort(5, this.state.sort_type5)}>Sort by Uptime</a>
                                <br/>
                            </div>
                        </div>
                        <div className="row mb-5">
                                    ...
                                    <Table style={{width: "100%"}}>
                                        <Thead>
                                            <Tr>
                                                ...
                                                <Th onClick={() => this.sort(1, this.state.sort_type1)}>Daily
                                                    Reward {this.state.sort_type1 === 0 ? "▼" : this.state.sort_type1 === 1 ? "▲" : null}</Th>
                                                <Th onClick={() => this.sort(1, this.state.sort_type1)}>Monthly
                                                    Reward {this.state.sort_type1 === 0 ? "▼" : this.state.sort_type1 === 1 ? "▲" : null}</Th>
                                                <Th>APY</Th>
                                                <Th></Th>
                                            </Tr>
                                            ...
                                            {this.state.validatorsInfo ?
                                                this.state.validators_data_temp.map((validator, index) => (
                                                    <Tr key={index + 1}>
                                                        ...
                                                        <Td>
                                                            {validator.website !== "" ?
                                                                <a href={validator.website}
                                                                   target='_blank'>{validator.name !== "" ? validator.name : "Not Set"}</a>
                                                                :
                                                                validator.name !== "" ? validator.name : "Not Set"
                                                            }
                                                        </Td>
                                                        <Td><a
                                                            href={'https://cspr.live/validator/' + validator.public_key}
                                                            target='_blank'>{utils.truncateStr(validator.public_key, 5)}</a></Td>
                                                        <Td><span
                                                            style={{color: validator.isActive ? "red" : "green"}}>{!validator.isActive ? "ACTIVE" : "INACTIVE"}</span></Td>
                                                        <Td><span
                                                            style={{color: validator.uptime <= 0.8 ? "red" : validator.uptime <= 0.9 ? "orange" : "green"}}>{parseInt(validator.uptime * 100)} %</span></Td>
